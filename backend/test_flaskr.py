...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {
            'question': 'What elementary particle was discovered in 2012?',
    ...
    def test_search_by_question_no_result(self):
        res = self.client().post('questions', json={'searchTerm': 'wankawonda'})
        data = json.loads(res.data)
    ...
    def test_422_play_quizz(self):
        new_quizz = {'previous_questions': [2]}
